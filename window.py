...
class WaveAnimation:
    def __init__(self, anim_fig, fig_size=(8, 6)):
        self.root = tk.Tk()
        ...
        self.fig.set_size_inches(fig_size[0]*SIZE, fig_size[1]*SIZE)
    ...
    def add_scales(self, min_wave_v=0, max_wave_v=2.0, min_ang_freq=0, max_ang_freq=1.0):
        """
        ...
        s_text.place(x=x_cord_k-20, y=y_beg-20)
        slider_len = 120*SIZE
        
        self.wave_v_scale1 = tk.Scale(master=self.root, from_=min_wave_v, to=max_wave_v, tickinterval=t_intrvl, resolution=resol, orient=tk.HORIZONTAL, label="w1", length=slider_len)
        self.wave_v_scale1.place(x=x_cord_k, y=y_beg)
        self.wave_v_scale2 = tk.Scale(master=self.root, from_=min_wave_v, to=max_wave_v, tickinterval=t_intrvl, resolution=resol, orient=tk.HORIZONTAL, label="w2", length=slider_len)
        self.wave_v_scale2.place(x=x_cord_k, y=y_beg+y_interval)
        self.wave_v_scale3 = tk.Scale(master=self.root, from_=min_wave_v, to=max_wave_v, tickinterval=t_intrvl, resolution=resol, orient=tk.HORIZONTAL, label="w3", length=slider_len)
        self.wave_v_scale3.place(x=x_cord_k, y=y_beg+2*y_interval)
        self.ang_freq_scale1 = tk.Scale(master=self.root, from_=min_ang_freq, to=max_ang_freq, tickinterval=t_intrvl, resolution=resol, orient=tk.HORIZONTAL, label="k1", length=slider_len)
        self.ang_freq_scale1.place(x=x_cord_w, y=y_beg) 
        self.ang_freq_scale2 = tk.Scale(master=self.root, from_=min_ang_freq, to=max_ang_freq, tickinterval=t_intrvl, resolution=resol, orient=tk.HORIZONTAL, label="k2", length=slider_len)
        self.ang_freq_scale2.place(x=x_cord_w, y=y_beg+y_interval)
        self.ang_freq_scale3 = tk.Scale(master=self.root, from_=min_ang_freq, to=max_ang_freq, tickinterval=t_intrvl, resolution=resol, orient=tk.HORIZONTAL, label="k3", length=slider_len)
    ...
    def add_example_buttons(self):
        ...
        text1 = f"w1  = {option1.wave_v1} \tw2  = {option1.wave_v2} \tw3  = {option1.wave_v3} \nk1 = {option1.ang_freq1} \tk2 = {option1.ang_freq2} \tk3 = {option1.ang_freq3}"
        text2 = f"w1  = {option2.wave_v1} \tw2  = {option2.wave_v2} \tw3  = {option2.wave_v3} \nk1 = {option2.ang_freq1} \tk2 = {option2.ang_freq2} \tk3 = {option2.ang_freq3}"
        text3 = f"w1  = {option3.wave_v1} \tw2  = {option3.wave_v2} \tw3  = {option3.wave_v3} \nk1 = {option3.ang_freq1} \tk2 = {option3.ang_freq2} \tk3 = {option3.ang_freq3}"
